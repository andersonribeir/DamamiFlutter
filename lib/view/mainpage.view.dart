...
class MainPage extends StatefulWidget {
  final String uid; // Adicionando o parâmetro
...
class _MainPageState extends State<MainPage> {
  ...
  Future<List<Unidade>> _fetchUnidades() async {
    final apiService = ApiService();
    final chartDataString =
    await apiService.GetUnidades(widget.uid);
    final jsonData = json.decode(chartDataString);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Parâmetros de consulta",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: isDark ? Colors.white : Colors.black,fontFamily: 'Roboto'),),
                  ),
                  ...
                  SizedBox(height: 15,child: Row(
                      ...
                      children:  [
                        SizedBox(width: 3,),
                        Text("Unidade de Produção",style: TextStyle(fontSize: 14,color: isDark ? Colors.white : Colors.black,fontFamily: 'Roboto')),
                        const SizedBox(width: 33,),
                        Text("Período em Anos",style: TextStyle(fontSize: 14,color: isDark ? Colors.white : Colors.black,fontFamily: 'Roboto')),
                      ]
                  ),),
                  const SizedBox(height:5),
                  SizedBox(
