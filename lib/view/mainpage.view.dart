...
class _MainPageState extends State<MainPage> {
  ...
  Future<List<Relatorio>> _fetchRelatorios(String relatorio,String unidade,String anoInicial, String anoFinal) async {
    ...
    final chartDataString = await apiService.GetChart(relatorio, unidade, anoInicial, anoFinal);
                  ...
                  if (snapshot.hasData) {
                    return SfCartesianChart(
                      ...
                      series: snapshot.data!
                          ...
                          color: GlobalColors.graphicColors[relatorio.ano % GlobalColors.graphicColors.length].withOpacity(1).withOpacity(0.3),
                          ...
                          markerSettings: MarkerSettings(
                            isVisible: true,
                            color: GlobalColors.graphicColors[relatorio.ano % GlobalColors.graphicColors.length],
